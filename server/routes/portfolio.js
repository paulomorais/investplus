...
exports.list = function(req, res) {
    console.log('GET: /stocks/portfolio - portfolio.list...');

    var items = [
        {id:1, name:'VALE5', price: 15.29, type: 'S', quantity: 1800, selected: true},
        {id:1, name:'PERT4', price: 12.00, type: 'S', quantity: 200, selected: false}
    ];
